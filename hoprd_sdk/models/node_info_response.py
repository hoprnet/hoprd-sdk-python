...
class NodeInfoResponse(object):
    ...
    attribute_map = {
        ...
        'indexer_last_log_block': 'indexerLastLogBlock',
        'indexer_last_log_checksum': 'indexerLastLogChecksum',
    ...
    def __init__(self, announced_address=None, chain=None, channel_closure_period=None, connectivity_status=None, hopr_channels=None, hopr_management_module=None, hopr_network_registry=None, hopr_node_safe=None, hopr_node_safe_registry=None, hopr_token=None, index_block_prev_checksum=None, indexer_block=None, indexer_checksum=None, indexer_last_log_block=None, indexer_last_log_checksum=None, is_eligible=None, listening_address=None, network=None, provider=None):  # noqa: E501
        ...
        self._indexer_last_log_block = None
        self._indexer_last_log_checksum = None
        ...
        self.indexer_last_log_block = indexer_last_log_block
        self.indexer_last_log_checksum = indexer_last_log_checksum
    ...
    @property
    def indexer_last_log_block(self):
        """Gets the indexer_last_log_block of this NodeInfoResponse.  # noqa: E501


        :return: The indexer_last_log_block of this NodeInfoResponse.  # noqa: E501
        :rtype: int
        """
        return self._indexer_last_log_block

    @indexer_last_log_block.setter
    def indexer_last_log_block(self, indexer_last_log_block):
        """Sets the indexer_last_log_block of this NodeInfoResponse.


        :param indexer_last_log_block: The indexer_last_log_block of this NodeInfoResponse.  # noqa: E501
        :type: int
        """
        if indexer_last_log_block is None:
            raise ValueError("Invalid value for `indexer_last_log_block`, must not be `None`")  # noqa: E501

        self._indexer_last_log_block = indexer_last_log_block

    @property
    def indexer_last_log_checksum(self):
        """Gets the indexer_last_log_checksum of this NodeInfoResponse.  # noqa: E501


        :return: The indexer_last_log_checksum of this NodeInfoResponse.  # noqa: E501
        :rtype: str
        """
        return self._indexer_last_log_checksum

    @indexer_last_log_checksum.setter
    def indexer_last_log_checksum(self, indexer_last_log_checksum):
        """Sets the indexer_last_log_checksum of this NodeInfoResponse.


        :param indexer_last_log_checksum: The indexer_last_log_checksum of this NodeInfoResponse.  # noqa: E501
        :type: str
        """
        if indexer_last_log_checksum is None:
            raise ValueError("Invalid value for `indexer_last_log_checksum`, must not be `None`")  # noqa: E501

        self._indexer_last_log_checksum = indexer_last_log_checksum
    ...
    @property
    def provider(self):
        """Gets the provider of this NodeInfoResponse.  # noqa: E501


        :return: The provider of this NodeInfoResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def provider(self, provider):
        """Sets the provider of this NodeInfoResponse.


        :param provider: The provider of this NodeInfoResponse.  # noqa: E501
        :type: str
        """
        if provider is None:
