...
class ChannelsApi(object):
    ...
    def close_channel(self, channel_id, **kwargs):  # noqa: E501
        ...
        Closes the given channel.  If the channel is currently `Open`, it will transition it to `PendingToClose`. If the channels is in `PendingToClose` and the channel closure period has elapsed, it will transition it to `Closed`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def list_channels(self, **kwargs):  # noqa: E501
        ...
        Lists channels opened to/from this node. Alternatively, it can print all the channels in the network as this node sees them.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def redeem_tickets_in_channel(self, channel_id, **kwargs):  # noqa: E501
        ...
        Starts redeeming all tickets in the given channel.  **WARNING:** this should almost **never** be used as it can issue a large number of on-chain transactions. The tickets should almost always be aggregated first.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
