...
class MessagesApi(object):
    ...
    def send_message(self, body, **kwargs):  # noqa: E501
        ...
        Send a message to another peer using the given path.  The message can be sent either over a specified path or using a specified number of HOPS, if no path is given.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
