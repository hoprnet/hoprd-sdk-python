...
class NodeApi(object):
    ...
    def channel_graph(self, **kwargs):  # noqa: E501
        """Retrieve node's channel graph in DOT or JSON format.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.channel_graph(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param bool ignore_disconnected_components: If set, nodes that are not connected to this node (via open channels) will not be exported. This setting automatically implies `ignore_non_opened_channels`.
        :param bool ignore_non_opened_channels: Do not export channels that are not in the `Open` state.
        :param bool raw_graph: Export the entire graph in raw JSON format, that can be later used to load the graph into e.g. a unit test.  Note that `ignore_disconnected_components` and `ignore_non_opened_channels` are ignored.
        :return: str
        ...
        if kwargs.get('async_req'):
            return self.channel_graph_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.channel_graph_with_http_info(**kwargs)  # noqa: E501
            return data

    def channel_graph_with_http_info(self, **kwargs):  # noqa: E501
        """Retrieve node's channel graph in DOT or JSON format.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.channel_graph_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['ignore_disconnected_components', 'ignore_non_opened_channels', 'raw_graph']  # noqa: E501
        ...
        query_params = []
        if 'ignore_disconnected_components' in params:
            query_params.append(('ignoreDisconnectedComponents', params['ignore_disconnected_components']))  # noqa: E501
        if 'ignore_non_opened_channels' in params:
            query_params.append(('ignoreNonOpenedChannels', params['ignore_non_opened_channels']))  # noqa: E501
        if 'raw_graph' in params:
            query_params.append(('rawGraph', params['raw_graph']))  # noqa: E501
    ...
    def peers(self, **kwargs):  # noqa: E501
        ...
        Connected peers are nodes which are connected to the node while announced peers are nodes which have announced to the network.  Optionally pass `quality` parameter to get only peers with higher or equal quality to the specified value.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def version(self, **kwargs):  # noqa: E501
        """Get the release version of the running node.  # noqa: E501
