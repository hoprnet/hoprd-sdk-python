...
class AliasApi(object):
    ...
    def aliases(self, **kwargs):  # noqa: E501
        """(deprecated, will be removed in v3.0) Get each previously set alias and its corresponding PeerId as a hashmap.  # noqa: E501
    ...
    def clear_aliases(self, **kwargs):  # noqa: E501
        """(deprecated, will be removed in v3.0) Clear all aliases.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.clear_aliases(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.clear_aliases_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.clear_aliases_with_http_info(**kwargs)  # noqa: E501
            return data

    def clear_aliases_with_http_info(self, **kwargs):  # noqa: E501
        """(deprecated, will be removed in v3.0) Clear all aliases.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.clear_aliases_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def set_alias(self, body, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param AliasDestinationBodyRequest body: Alias name along with the PeerId to be aliased (required)
        :return: PeerIdResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
