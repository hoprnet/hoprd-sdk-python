...
class TokenCapability(object):
    ...
    def endpoint(self, endpoint):
        ...
        allowed_values = ["tokensCreate", "tokensGetToken", "ticketsGetStatistics", "ticketsRedeemTickets", "ticketsGetTickets", "settingsGetSettings", "nodeGetVersion", "nodeStreamWebsocket", "nodePing", "nodeGetPeers", "nodeGetMetrics", "nodeGetInfo", "nodeGetEntryNodes", "messagesWebsocket", "messagesSign", "messagesSendMessage", "messageSign", "channelsFundChannels", "channelsOpenChannel", "channelsGetChannels", "aliasesSetAlias", "aliasesGetAliases", "accountWithdraw", "accountGetBalances", "accountGetAddresses", "accountGetAddress", "tokensDelete", "settingsSetSetting", "peerInfoGetPeerInfo", "channelsRedeemTickets", "channelsGetTickets", "channelsGetChannel", "channelsCloseChannel", "aliasesGetAlias", "aliasesRemoveAlias"]  # noqa: E501
