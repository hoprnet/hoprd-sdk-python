...
class TokenCapability(object):
    ...
    def endpoint(self, endpoint):
        ...
        allowed_values = ["tokensCreate", "tokensGetToken", "ticketsGetStatistics", "ticketsRedeemTickets", "ticketsGetTickets", "settingsGetSettings", "nodeGetVersion", "nodeGetPeers", "nodeGetMetrics", "nodeGetInfo", "nodeGetEntryNodes", "messagesWebsocket", "messagesGetSize", "messagesPopAllMessage", "messagesPopMessage", "messagesSendMessage", "messagesDeleteMessages", "channelsOpenChannel", "channelsGetChannels", "aliasesSetAlias", "aliasesGetAliases", "accountWithdraw", "accountGetBalances", "accountGetAddresses", "accountGetAddress", "tokensDelete", "settingsSetSetting", "peersPingPeer", "peerInfoGetPeerInfo", "channelsRedeemTickets", "channelsGetTickets", "channelsGetChannel", "channelsCloseChannel", "aliasesGetAlias", "aliasesRemoveAlias", "nodeStreamWebsocket", "nodePing", "messagesSign", "messageSign", "channelsFundChannels"]  # noqa: E501
