...
class ChannelsBody(object):
    ...
    @property
    def amount(self):
        """Gets the amount of this ChannelsBody.  # noqa: E501

        Amount of HOPR tokens to fund the channel. It will be used to pay for sending messages through channel  # noqa: E501

        :return: The amount of this ChannelsBody.  # noqa: E501
        :rtype: str
        """
        return self._amount
    ...
    def amount(self, amount):
        """Sets the amount of this ChannelsBody.

        Amount of HOPR tokens to fund the channel. It will be used to pay for sending messages through channel  # noqa: E501

        :param amount: The amount of this ChannelsBody.  # noqa: E501
        :type: str
        """
        if amount is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ChannelsBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ChannelsBody):
            return False
