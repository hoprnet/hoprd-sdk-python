...
class ChannelsApi(object):
    ...
    def channels_close_channel(self, peerid, direction, **kwargs):  # noqa: E501
        ...
        >>> thread = api.channels_close_channel(peerid, direction, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str peerid: (required)
        :param str direction: Specify which channel should be fetched, incoming or outgoing. (required)
        ...
        if kwargs.get('async_req'):
            return self.channels_close_channel_with_http_info(peerid, direction, **kwargs)  # noqa: E501
        else:
            (data) = self.channels_close_channel_with_http_info(peerid, direction, **kwargs)  # noqa: E501
            return data

    def channels_close_channel_with_http_info(self, peerid, direction, **kwargs):  # noqa: E501
        """channels_close_channel  # noqa: E501

        Close a opened channel between this node and other node. Once you've initiated channel closure, you have to wait for a specified closure time, it will show you a closure initiation message with cool-off time you need to wait.   Then you will need to send the same command again to finalize closure. This is a cool down period to give the other party in the channel sufficient time to redeem their tickets.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.channels_close_channel_with_http_info(peerid, direction, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['peerid', 'direction']  # noqa: E501
        ...
        if ('peerid' not in params or
            ...
            raise ValueError("Missing the required parameter `peerid` when calling `channels_close_channel`")  # noqa: E501
        # verify the required parameter 'direction' is set
        if ('direction' not in params or
                params['direction'] is None):
            raise ValueError("Missing the required parameter `direction` when calling `channels_close_channel`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/channels/{peerid}/{direction}/', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def channels_fund_channels(self, **kwargs):  # noqa: E501
        """channels_fund_channels  # noqa: E501

        Fund one or two payment channels between this node and the counter party provided.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.channels_fund_channels(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.channels_fund_channels_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.channels_fund_channels_with_http_info(**kwargs)  # noqa: E501
            return data

    def channels_fund_channels_with_http_info(self, **kwargs):  # noqa: E501
        """channels_fund_channels  # noqa: E501

        Fund one or two payment channels between this node and the counter party provided.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.channels_fund_channels_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method channels_fund_channels" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def channels_get_channel(self, peerid, direction, **kwargs):  # noqa: E501
        """channels_get_channel  # noqa: E501

        Returns information about the channel between this node and provided peerId.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.channels_get_channel(peerid, direction, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param HoprAddress peerid: Counterparty peerId assigned to the channel you want to fetch. (required)
        :param str direction: Specify which channel should be fetched, incoming or outgoing. (required)
        :return: list[Channel]
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.channels_get_channel_with_http_info(peerid, direction, **kwargs)  # noqa: E501
        else:
            (data) = self.channels_get_channel_with_http_info(peerid, direction, **kwargs)  # noqa: E501
            return data

    def channels_get_channel_with_http_info(self, peerid, direction, **kwargs):  # noqa: E501
        """channels_get_channel  # noqa: E501

        Returns information about the channel between this node and provided peerId.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.channels_get_channel_with_http_info(peerid, direction, async_req=True)
        >>> result = thread.get()
        ...
        if ('peerid' not in params or
                params['peerid'] is None):
            raise ValueError("Missing the required parameter `peerid` when calling `channels_get_channel`")  # noqa: E501
        # verify the required parameter 'direction' is set
        if ('direction' not in params or
                params['direction'] is None):
            raise ValueError("Missing the required parameter `direction` when calling `channels_get_channel`")  # noqa: E501
    ...
    def channels_get_tickets(self, peerid, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.channels_get_tickets(peerid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.channels_get_tickets_with_http_info(peerid, **kwargs)  # noqa: E501
        else:
            (data) = self.channels_get_tickets_with_http_info(peerid, **kwargs)  # noqa: E501
            return data

    def channels_get_tickets_with_http_info(self, peerid, **kwargs):  # noqa: E501
        """channels_get_tickets  # noqa: E501

        Get tickets earned by relaying data packets by your node for the particular channel.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.channels_get_tickets_with_http_info(peerid, async_req=True)
        >>> result = thread.get()
        ...
        if ('peerid' not in params or
                params['peerid'] is None):
            raise ValueError("Missing the required parameter `peerid` when calling `channels_get_tickets`")  # noqa: E501
    ...
    def channels_redeem_tickets(self, peerid, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.channels_redeem_tickets(peerid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.channels_redeem_tickets_with_http_info(peerid, **kwargs)  # noqa: E501
        else:
            (data) = self.channels_redeem_tickets_with_http_info(peerid, **kwargs)  # noqa: E501
            return data

    def channels_redeem_tickets_with_http_info(self, peerid, **kwargs):  # noqa: E501
        """channels_redeem_tickets  # noqa: E501

        Redeems your tickets for this channel. Redeeming will change your tickets into Hopr tokens if they are winning ones. You can check how much tickets given channel has by calling /channels/{peerid}/tickets endpoint. Do this before channel is closed as neglected tickets are no longer valid for redeeming.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.channels_redeem_tickets_with_http_info(peerid, async_req=True)
        >>> result = thread.get()
        ...
        if ('peerid' not in params or
                params['peerid'] is None):
            raise ValueError("Missing the required parameter `peerid` when calling `channels_redeem_tickets`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/channels/{peerid}/tickets/redeem', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
